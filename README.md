...
> Status: stable. Open-core packages on nuget.org — `Asdamir.Core` `1.6.0`, `Asdamir.Data` `1.4.0`, `Asdamir.Web` `1.5.3`, `Asdamir.Payments` `1.2.0`, `Asdamir.Tools` `1.4.5`. Production-ready; semantic versioning — breaking changes bump the major. The production-readiness features below are in place.
