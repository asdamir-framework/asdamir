...
/// <summary>
/// <c>framework add field &lt;EntityName&gt; --field "Name:type" [--output dir]</c>
///
...
public static class AddFieldCommand
{
    ...
    {
        var nameArg = new Argument<string>("entity", "PascalCase entity name that was previously created via `framework new entity`.");
    ...
    private static string RenderMigration(string entityName, FieldSpec f, string stamp)
    {
        ...
        return $"""
            ...
            --   Generated by `framework add field {entityName} --field "{f.Name}:{f.CSharpType.TrimEnd('?')}{(f.IsNullable ? "?" : "")}"` on {DateTime.UtcNow:u}.
            --   Stamp: V{stamp}
            -- </auto-generated>
